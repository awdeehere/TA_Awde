<x-base>
    <header class="page-header" data-background="{{ url('/') }}/frontview/images/3.jpg">
        <div class="inner">
            ...
            <h1>Galeri</h1>
            <p>Selamat datang di galeri kain pelangi kami. Temukan keindahan dan keragaman warna dalam setiap helai kain yang kami tawarkan. Nikmati koleksi eksklusif kami yang memadukan seni dan kualitas dalam setiap detailnya.</p>
        </div>
        <!-- end inner -->
    </header>
    <!-- Penghargaan -->
