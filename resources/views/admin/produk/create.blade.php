                    ...
                    <form action="{{ url('admin/produk') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="nama_motif" id="nama_motif" value="{{ old('nama_motif') }}">
                                @error('nama_motif')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="hak_cipta" id="hak_cipta" class="form-control mb-3" value="{{ old('hak_cipta') }}">
                                @error('hak_cipta')
                                    <p class="text-danger" style="font-size: 12px">* {{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="warna" id="warna" class="form-control mb-3" value="{{ old('warna') }}">
                                @error('warna')
                                    <p class="text-danger" style="font-size: 12px">* {{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="lebar_kain" id="lebar_kain" class="form-control mb-3" value="{{ old('lebar_kain') }}">
                                @error('lebar_kain')
                                    <p class="text-danger" style="font-size: 12px">* {{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="jenis_produk" id="jenis_produk" class="form-control mb-3" value="{{ old('jenis_produk') }}">
                                @error('jenis_produk')
                                    <p class="text-danger" style="font-size: 12px">* {{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="6">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <p class="text-danger" style="font-size: 12px">* {{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="cara_perawatan" id="cara_perawatan" cols="30" rows="6">{{ old('cara_perawatan') }}</textarea>
